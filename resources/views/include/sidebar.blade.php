 ...
 <div id="drawer-navigation" class="fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
    <div class="p-4">
        <h5 id="drawer-navigation-label" class=" text-3xl text-center font-jsmath font-semibold text-gray-500 dark:text-gray-400">Mygallery</h5>
       ...
       <ul class="space-y-2 font-medium">
          <li class="p-4">
             <a href="{{ url("profile") }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span class="ms-3">Myprofile</span>
             </a>
          </li>
          <li class="p-4">
             <a href="{{ url("album") }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Myalbum</span>
             </a>
          </li>
          <li class="p-4">
