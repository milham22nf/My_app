$.getJSON('/profil/getDataprof', function(res){
    console.log(res);
...
function loadMoreData(paginate){
    var segmentTerakhir = window.location.origin + '/profil/getDataprof/';
    $.ajax({
        url: window.location.origin+'/getDataProfileExplore/'+'?page='+paginate,
        type: "GET",
        dataType: "JSON",
        data:{
    ...
    $.ajax({
        ...
        error: function(jqXHR, textStatus, errorThrown){
            alert('gagal')
                        ...
                        // <span class="bi bi-trash" onclick="deleteFoto(${x.id})"></span>

// // function deleteFoto(id) {
//     $.ajax({
//         url: window.location.origin + '/Deletefotos',
//         dataType: "JSON",
//         type: "POST",
//         data: {
//             _token: $('input[name="_token"]').val(),
